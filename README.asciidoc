...
// * https://github.com/DMBuce/bucepack/blob/master/buce-data/mythic/chromatic/fireworks.loot_table.json.yaml.sempl[After]
// * https://github.com/DMBuce/bucepack/blob/master/buce-data/mythic/chromatic/fireworks.loot_table.json.yaml[Output]
