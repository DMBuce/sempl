...
Some real-world examples where I replaced annoying scripts in my
projects with Sempl.

In my
https://github.com/DMBuce/bucepack/tree/5631a3796c35ccdb9eb0091fb2c7658827947145#mythic-relics[Mythic Relics]
minecraft datapack, I needed to generate a JSON loot table with 784 firework
entry, one for almost every possible combination of shape, flicker state,
trail effect, color, and fade color.
Here is how I did that at first with shell and later with Sempl, along with
the output data.

* https://github.com/DMBuce/bucepack/blob/05d6df71cde88aecd00c38324a7e40689bd1090c/bin/mk-fireworks.sh[Before]
* https://github.com/DMBuce/bucepack/blob/5631a3796c35ccdb9eb0091fb2c7658827947145/buce-data/mythic/chromatic/fireworks.loot_table.json.yaml.sempl[After]
...
Here, I am generating some data for my
https://github.com/DMBuce/bucepack/tree/73c69a14c90a585ac39ca54d198efa343fb3be8d#dragonproof-end[Dragonproof]
datapack that automatically includes all magenta blocks in the game.

* https://github.com/DMBuce/bucepack/blob/5631a3796c35ccdb9eb0091fb2c7658827947145/bin/update-dragonproof.sh[Before]
* https://github.com/DMBuce/bucepack/blob/78fd32afc0ae00d432f9972ad379561d2d469386/data/minecraft/tags/blocks/dragon_immune.json.sempl[After]
